...
userRouter.post('/signup', async (req, res) => {
    try {
        ...
        const newUser = await SongUserModel.create(obj);
...
userRouter.put('/', async (req, res) => {
    try {
        ...
        const result = await SongUserModel.updateOne(condition, newObj);
...
userRouter.delete('/', async (req, res) => {
    try {
        ...
        const result = await SongUserModel.deleteOne(condition);
        /**     👆  --> desc about how you will get result in above code.
         * Below is the data format which you will get as a result
            {
               "acknowledged": true,
